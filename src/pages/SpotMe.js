    ...
    <div className="grid-container">
      ...
      <div className="grid-x grid-padding-x">
        ...
        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-1.png" alt="SpotMe lending concept — loan initiation screen designed during 3-day Google Design Sprint" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-2.png" alt="SpotMe lending concept — contact selection screen for choosing loan recipient" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-3.png" alt="SpotMe lending concept — loan amount and terms configuration screen" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-4.png" alt="SpotMe lending concept — loan confirmation and repayment schedule screen" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-5.png" alt="SpotMe lending concept — loan status and activity tracking screen" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-6.png" alt="SpotMe lending concept — payment receipt and notification screen" />
        </div>
      </div>
      ...
      <div className="grid-x grid-padding-x">
        ...
        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-b.png" alt="SpotMe App Store-style concept tester — explainer screen used to validate the lending idea with real Netspend users" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-c.png" alt="SpotMe App Store-style concept tester — feature overview screen used in user validation testing" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-d.png" alt="SpotMe App Store-style concept tester — how it works screen explaining the peer lending flow to test users" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-e.png" alt="SpotMe App Store-style concept tester — user reviews screen gathering qualitative feedback on the lending concept" />
        </div>

        <div className="large-2 medium-2 small-4 cell" style={{ marginBottom: '20px' }}>
          <img src="/images/work/sp-f.png" alt="SpotMe App Store-style concept tester — privacy and permissions screen assessing user comfort with the social lending feature" />
        </div>
