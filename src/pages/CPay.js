    ...
    <div className="grid-container">
      ...
      <div className="grid-x grid-padding-x" style={{ paddingBottom: '20px' }}>
        ...
        <div className="auto cell">
          <img src="/images/work/sketch1.jpg" alt="sketch" />
        </div>

        <div className="auto cell">
          <img src="/images/work/sketch2.jpg" alt="sketch" />
        </div>

        <div className="auto cell">
          <img src="/images/work/sketch3.jpg" alt="sketch" />
        </div>

        <div className="auto cell">
          <img src="/images/work/sketch4.jpg" alt="sketch" />
        </div>
      </div>

      <div className="grid-x grid-padding-x">
        <div className="auto cell">
          <img src="/images/work/sketch5.jpg" alt="sketch" />
        </div>

        <div className="auto cell">
          <img src="/images/work/sketch6.jpg" alt="sketch" />
        </div>

        <div className="auto cell">
          <img src="/images/work/sketch7.jpg" alt="sketch" />
        </div>

        <div className="auto cell">
          <img src="/images/work/sketch8.jpg" alt="sketch" />
        </div>
      </div>
      ...
      <div className="grid-x grid-padding-x" style={{ paddingBottom: '20px' }}>
        ...
        <div className="large-8 cell">
          <img src="/images/work/storyboard.jpg" alt="storyboard" />
        </div>
      </div>
      ...
      <div className="grid-x grid-padding-x">
        ...
        <div className="large-3 medium-3 small-6 cell" style={{ paddingBottom: '20px' }}>
          <img src="/images/work/cpay_proto1.png" alt="proto" />
        </div>

        <div className="large-3 medium-3 small-6 cell">
          <img src="/images/work/cpay_proto2.png" alt="proto" />
        </div>

        <div className="large-3 medium-3 small-6 cell">
          <img src="/images/work/cpay_proto3.png" alt="proto" />
        </div>

        <div className="large-3 medium-3 small-6 cell">
          <img src="/images/work/cpay_proto4.png" alt="proto" />
        </div>
      </div>
