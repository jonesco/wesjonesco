  ...
  return (
    <div className="page">
      ...
      <div className="cols-3">
        <img src="/images/work/wayblazer_home2.png" alt="Wayblazer search results page showing AI-curated hotel and activity recommendations" />
        <img src="/images/work/wayblazer_home3.png" alt="Wayblazer detail view showing AI-suggested activities and trip enhancements based on predicted traveler type" />
        <img src="/images/work/wayblazer_home4.png" alt="Wayblazer white-label integration view demonstrating seamless embedding inside a third-party travel site" />
      </div>
      ...
      <div className="cols-3">
        <img src="/images/work/wayblazer_mobile1.png" alt="Wayblazer mobile responsive design — search interface on a smartphone" />
        <img src="/images/work/wayblazer_mobile3.png" alt="Wayblazer mobile responsive design — results view on a smartphone" />
        <img src="/images/work/wayblazer_mobile2.png" alt="Wayblazer mobile responsive design — activity detail view on a smartphone" />
      </div>
