...
function NetspendPatternLibrary() {
  useEffect(() => {
    document.title = 'Netspend Pattern Library — Wes Jones, Lead Product Designer';
  }, []);
  ...
  return (
    <div className="page">
      ...
      <div className="cols-1-3">
        ...
        <div>
          <img src="/images/work/NSPL1.png" alt="Netspend Pattern Library built in Figma, showing the full design system structure organized by Principles, Basics, Components, Layouts, and Features" />
        </div>
      </div>

      <hr />

      <div style={{ backgroundColor: '#cccccc', padding: '20px 10px 25px', borderRadius: '10px' }}>
        <p><i>▼ Examples of component pages</i></p>
        <div className="cols-4">
          <img src="/images/work/Illustrations.png" alt="Netspend Pattern Library — Illustrations component page showing illustration usage guidelines" />
          <img src="/images/work/Interrupt.png" alt="Netspend Pattern Library — Interrupt component page showing modal and dialog pattern documentation" />
          <img src="/images/work/Layout.png" alt="Netspend Pattern Library — Layout component page documenting page structure and section patterns" />
          <img src="/images/work/Notifications.png" alt="Netspend Pattern Library — Notifications component page showing alert and messaging pattern specifications" />
        </div>
      </div>
      ...
      <div>
        ...
        <div className="indented" style={{ marginTop: '20px' }}>
      ...
      <div className="cols-2">
        <div>
          <img src="/images/work/netspend_sticker_sheet.png" alt="Netspend Sticker Sheet component library — the management system powering the pattern library, built to keep designers, developers, and product teams aligned" />
        </div>
        <div>
      ...
      <div>
        ...
        <img src="/images/work/PL_tools.png" alt="Netspend Pattern Library documentation redline tools — a uniform set of markup components for explaining how patterns are constructed and perform" style={{ marginTop: '1rem' }} />
      </div>
