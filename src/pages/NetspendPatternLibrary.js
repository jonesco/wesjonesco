    ...
    <div className="grid-container">
      ...
      <div className="grid-x grid-padding-x" style={{ backgroundColor: '#cccccc', marginLeft: '0px', paddingLeft: '10px', marginRight: '0px', paddingRight: '10px', paddingBottom: '25px', paddingTop: '20px', borderRadius: '10px' }}>
        ...
        <div className="large-3 medium-3 small-3 cell" id="">
          <img src="/images/work/Illustrations.png" alt="Netspend Pattern Library — Illustrations component page showing illustration usage guidelines" width=" " height=" " />
        </div>

        <div className="large-3 medium-3 small-3 cell" id="">
          <img src="/images/work/Interrupt.png" alt="Netspend Pattern Library — Interrupt component page showing modal and dialog pattern documentation" width=" " height=" " />
        </div>

        <div className="large-3 medium-3 small-3 cell" id="">
          <img src="/images/work/Layout.png" alt="Netspend Pattern Library — Layout component page documenting page structure and section patterns" width=" " height=" " />
        </div>

        <div className="large-3 medium-3 small-3 cell" id="">
          <img src="/images/work/Notifications.png" alt="Netspend Pattern Library — Notifications component page showing alert and messaging pattern specifications" width=" " height=" " />
        </div>
      </div>
      ...
      <div className="grid-x grid-padding-x">
        <div className="large-6 medium-6 small-12 cell" id="">
          <img src="/images/work/netspend_sticker_sheet.png" alt="Netspend Sticker Sheet component library — the management system powering the pattern library, built to keep designers, developers, and product teams aligned" width=" " height=" " />
        </div>
      ...
      <div className="grid-x grid-padding-x">
        ...
        <div className="large-12 cell" id="spacebelow">
          <img src="/images/work/PL_tools.png" alt="Netspend Pattern Library documentation redline tools — a uniform set of markup components for explaining how patterns are constructed and perform" width=" " height=" " />
        </div>
      </div>
