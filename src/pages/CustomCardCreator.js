...
function CustomCardCreator() {
  useEffect(() => {
    document.title = 'Custom Debit Card Creator — Wes Jones, Lead Product Designer';
  }, []);
  ...
  return (
    <div className="page">
      ...
      <div className="cols-2-1">
        ...
        <div>
          <img src="/images/work/cc5.jpg" style={{ borderRadius: '10px' }} alt="Example of a Netspend debit card customized with emoji art using the Custom Card Creator feature" />
        </div>
      </div>
      ...
      <div className="cols-2">
        ...
        <div>
          <img src="/images/work/cc1.png" alt="Custom Debit Card Creator UI showing background color selection and emoji picker interface, allowing users to pinch, zoom, and rotate emoji onto their card art" />
        </div>
      </div>
      ...
      <div className="cols-4">
        <img src="/images/work/cc2.png" alt="Card example" />
        <img src="/images/work/cc3.png" alt="Card example" />
        <img src="/images/work/cc4.png" alt="Card example" />
        <img src="/images/work/cc5.png" alt="Card example" />
        <img src="/images/work/cc6.png" alt="Card example" />
        <img src="/images/work/cc7.png" alt="Card example" />
        <img src="/images/work/cc8.png" alt="Card example" />
        <img src="/images/work/cc9.png" alt="Card example" />
      </div>
