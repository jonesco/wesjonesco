    ...
    <div className="grid-container">
      ...
      <div className="grid-x grid-padding-x">
        ...
        <div className="large-4 cell">
          <span><img src="/images/work/cc5.jpg" style={{ borderRadius: '10px' }} alt="Example of a Netspend debit card customized with emoji art using the Custom Card Creator feature" /></span>
        </div>
      </div>
      ...
      <div className="grid-x grid-padding-x">
        ...
        <div className="large-6 cell" id="">
          <img src="/images/work/cc1.png" alt="Custom Debit Card Creator UI showing background color selection and emoji picker interface, allowing users to pinch, zoom, and rotate emoji onto their card art" width=" " height=" " />
        </div>
      </div>
