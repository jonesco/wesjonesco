...
function FundManager() {
  useEffect(() => {
    document.title = 'Fund Manager Workspace — Wes Jones, Lead Product Designer';
  }, []);
    ...
    <div className="grid-container">
      ...
      <div>
        <div className="large-12 cell" style={{ marginBottom: '0px' }}>
          <img src="/images/work/f0.png" alt="Fund Manager dashboard integrating data from four systems, automating previously manual tasks and displaying clear system status with task assignment and audit capabilities" />
        ...
        <div className="grid-x grid-margin-x">
          <div className="large-6 medium-6 small-12 cell" style={{ marginBottom: '32px' }}>
            <div>
              <img src="/images/work/f2.png" alt="Fund Manager complex workflow redesigned as a user-friendly interface with clear progress indicators and precise multi-step interactions" className="shadowed-div" />
          ...
          <div className="large-6 medium-6 small-12 cell">
            <div>
              <img src="/images/work/f3.png" alt="Fund Manager globally applied design patterns enabling users to manipulate large data sets with intuitively placed, anticipated controls" className="shadowed-div" />
          ...
          <div className="large-6 medium-6 small-12 cell">
            <div>
              <img src="/images/work/f4.png" alt="Fund Manager smart data-fetching interface with dynamic warnings and highlighted required fields to prevent manual errors" className="shadowed-div" />
          ...
          <div className="large-6 medium-6 small-12 cell">
            <div>
              <img src="/images/work/f5.png" alt="Fund Manager approval workflow promoting transparency and cross-team collaboration with clear accountability and communication" className="shadowed-div" />
