...
function MagicStaff() {
  useEffect(() => {
    document.title = 'MagicStaff Developer Staffing POC — Wes Jones, Lead Product Designer';
  }, []);
  ...
  return (
    <div className="grid-container">
      ...
      <div>
        <h4>
          <img className="floaterleft" src="/images/work/mscap.png" alt="MagicStaff app icon" style={{ boxShadow: '0px 0px 5px rgba(0, 0, 0, 0.2)', borderRadius: '10px', width: '60px', height: '60px', marginRight: '16px', marginTop: '8px' }} />
        ...
        <div className="grid-x grid-padding-x">
          <div className="large-12 cell" style={{ marginBottom: '0px' }}>
            <img src="/images/work/ms0.png" alt="MagicStaff staffing platform main dashboard showing global team overview and project staffing status" />
          </div>
        </div>
        ...
        <div className="grid-x grid-margin-x show-for-large">
          ...
          <div className="cell large-4">
            ...
            <div className="grid-y">
              ...
              <div className="cell">
                <img src="/images/work/msmap.png" style={{ marginRight: '24px', padding: '24px' }} alt="MagicStaff global map visualization showing developer locations used for distributed team staffing optimization" />
              </div>
            </div>
          </div>
          ...
          <div className="cell large-8">
            ...
            <img src="/images/work/ms5.png" alt="MagicStaff project setup screen where users specify work duration, precise staffing needs, and required skills to initialize the optimization" />
            <div>
        ...
        <div className="grid-x grid-margin-x hide-for-large">
          ...
          <div className="medium-7 small-12 cell">
            <img src="/images/work/msmap.png" alt="MagicStaff global map visualization showing developer locations used for distributed team staffing optimization" style={{ padding: '24px' }} />
          </div>
        ...
        <div className="grid-x grid-margin-x">
          <div className="large-3 medium-6 small-6 cell" style={{ marginBottom: '32px' }}>
            <div>
              <img src="/images/work/ms1.png" alt="MagicStaff employee preference presets — quick adaptive inputs that capture workforce preferences and aspirations for consideration in staffing decisions" />
            </div>
          </div>
          ...
          <div className="large-3 medium-6 small-6 cell" style={{ marginBottom: '32px' }}>
            <div>
              <img src="/images/work/ms3.png" alt="MagicStaff employee skill tree showing areas of expertise alongside skills being actively developed for upskilling and staffing versatility" />
            </div>
          </div>
          ...
          <div className="large-3 medium-6 small-6 cell" style={{ marginBottom: '32px' }}>
            <div>
              <img src="/images/work/ms4.png" alt="MagicStaff employee profile with administrator notes providing a comprehensive view of the employee's current project status and staffing context" />
            </div>
          </div>
          ...
          <div className="large-3 medium-6 small-6 cell" style={{ marginBottom: '32px' }}>
            <div>
              <img src="/images/work/ms7.png" alt="MagicStaff calendar view showing company-wide staffing impact with over and under allocation highlights across projects" />
            </div>
          </div>
        ...
        <div className="grid-x grid-padding-x">
          ...
          <div className="large-6 medium-12 small-12 cell" id="">
            <img src="/images/work/ms6.png" alt="MagicStaff results screen showing ranked staffing assignment options with scored recommendations explaining why each option fits the project's schedule, skill requirements, and worker preferences" />
          </div>
        </div>
