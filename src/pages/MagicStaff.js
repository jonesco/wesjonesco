    ...
    <div className="page">
      ...
      <div className="cols-1-2">
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div>
            <img src="/images/work/msmap.png" style={{ padding: '24px' }} alt="MagicStaff global map visualization showing developer locations used for distributed team staffing optimization" />
          </div>
        </div>
        <div>
